const questions = [
  {
    ...
    answers: [
      "a) Relevo é a forma da superfície da Terra, como montanhas, vales e planícies.", // resposta correta
  ...
  },
  {
    ...
    answers: [
      ...
      "c) a) São forças dentro da Terra, como os terremotos e vulcões, que mudam a forma da superfície.", // resposta correta
  ...
  },
  {
    ...
    answers: [
      ...
      "b) a) Durante um terremoto, o relevo pode se rachar, afundar ou levantar.", // resposta correta
  ...
  },
  {
    ...
    answers: [
      ...
      "b) a) O Norte magnético é o ponto que a bússola aponta, que pode não ser o mesmo que o Norte verdadeiro.", // resposta correta
